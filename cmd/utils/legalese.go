...
INTRICACIES OF CRYPTOGRAPHIC TOKENS AND BLOCKCHAIN-BASED OPEN SOURCE SOFTWARE, SHIFT PLATFORM AND SHT.
...
BY OR RELATED TO RISKS OF, USE OF, OR INABILITY TO USE, SHT OR THE SHIFT PLATFORM UNDER ANY CAUSE
OR ACTION WHATSOEVER OF ANY KIND IN ANY JURISDICTION, INCLUDING, WITHOUT LIMITATION, ACTIONS FOR
BREACH OF WARRANTY, BREACH OF CONTRACT OR TORT (INCLUDING NEGLIGENCE) AND THAT SHIFT TEAM SHALL BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY OR
...
INJURY ARISING FROM ANY WILLFUL MISCONDUCT OR FRAUD OF SHIFT CRYPTOCURRENCY.
